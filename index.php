...
<html lang="en-US">
    <head>
        <title>Theseus</title>
        <meta name="description" content="TODO: insert description">
        <meta name="keywords" content="TODO: insert keywords">
    ...
    <body>
        <nav>
            ...
            <div class="nav-int max-width">
                <a href="/" class="logo">Theseus</a>
